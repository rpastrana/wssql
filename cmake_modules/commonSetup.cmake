...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  option(USE_LIBXML2 "Configure use of libxml" OFF)
  ...
  if ( USE_XALAN AND USE_LIBXSLT )
      set(USE_XALAN OFF CACHE BOOL "")
  endif()

  if ( USE_LIBXSLT )
      set(USE_LIBXML2 ON CACHE BOOL "")
  endif()
  ...
  set(projname ${WSSQL_PROJECT})
  set(majorver ${WSSQL_MAJOR})
  set(minorver ${WSSQL_MINOR})
  set(point ${WSSQL_POINT})
  if ( "${WSSQL_MATURITY}" STREQUAL "release" )
    set(stagever "${WSSQL_SEQUENCE}")
  else()
    set(stagever "${WSSQL_MATURITY}${WSSQL_SEQUENCE}")
  endif()
